...
``stacker-migratable-aws-stacker`` but you may choose any unique value.

Project tree
=================

In this example we have a product called ``migratable-aws-stacker`` and two environments
called ``dev`` and ``prod``.
